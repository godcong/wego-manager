//go:generate statik -f -src=./webui
package main
...
import (
	...
	"github.com/godcong/wego-manager/database"
	"github.com/godcong/wego-manager/model"
	"github.com/godcong/wego-manager/service"
	"os"
	"os/signal"
	"syscall"
)
...
import (
	...
	_ "github.com/godcong/wego-manager/docs" // docs is generated by Swag CLI, you have to import it.
	_ "github.com/godcong/wego-manager/statik"
)
